...
import { getCartTotal, decreaseQuantity, increaseQuantity, removeItem } from '../features/CartSlice'
                                        ...
                                        cart.map((data => (
                                            <div className="row">
                                                ...
                                                <div className="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                                    ...
                                                    <button onClick={() => dispatch(removeItem(data))} type="button" className="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip"
                                                        title="Remove item">
